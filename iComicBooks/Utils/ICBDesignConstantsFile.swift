...
extension UIColor {
    ...
    static let redComicViewFrameColor = UIColor(red: 0.73, green: 0.04, blue: 0.16, alpha: 1.0)
    static let yellowComicViewFrameColor = UIColor(red: 1.0, green: 0.75, blue: 0.0, alpha: 1.0)
    static let blueComicViewFrameColor = UIColor(red: 0.16, green: 0.57, blue: 0.75, alpha: 1.0)
}
